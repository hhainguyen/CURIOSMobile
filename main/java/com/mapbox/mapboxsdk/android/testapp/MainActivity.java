...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        testFragmentNames.add("CURIOS Map");
        testFragmentNames.add("Random Things");
        testFragmentNames.add("Search");
        testFragmentNames.add("View Later");
        testFragmentNames.add("User Settings");
